...
Executing all over scripts properly means:
   ...
   4. In *scripts/generate_graphs.py* disable use of cached values and set ``SHOW_PLOT`` to False in lines 13, 14 and 24. Enable both pn-value and current plots in lines 20 and 21.
   ...
   8. In *scripts/generate_ode_graphs.py* disable ``SHOW_PLOT`` in line 8
