...
plt_cc.plot(xx_p, log10(p_p), "C0", label = "$log_{10}$ $p (x)$")
plt_cc.plot(xx_n, log10(p_n), "C0")
plt_cc.plot(xx_p, log10(n_p), "C1", label = "$log_{10}$ $n (x)$")
plt_cc.plot(xx_n, log10(n_n), "C1")
